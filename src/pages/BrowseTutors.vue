      ...
      <div class="md-layout-item md-size-100">
        <md-card>
          <md-card-header data-background-color="blue">
            <h4 class="title">Browse All Tutors</h4>
            <p class="category">Find the perfect tutor for your needs</p>
          </md-card-header>
          <md-card-content>
            <div class="md-layout md-gutter" style="margin-bottom: 24px">
              <div class="md-layout-item md-size-100">
                <md-field>
                  ...
                  <label>Search tutors by name or subject...</label>
                  <md-input v-model="searchQuery"></md-input>
                </md-field>
              </div>
            </div>

            <div v-if="filteredTutors.length === 0" class="md-body-1">
              No tutors found.
            </div>
...
export default {
  ...
  computed: {
    filteredTutors() {
      ...
      return this.allTutors.filter(
        (tutor) =>
          tutor.name.toLowerCase().includes(query) ||
          (tutor.subjects && tutor.subjects.toLowerCase().includes(query)) ||
    ...
    loadAllTutors() {
      ...
      const mockTutors = [
        ...
        },
        {
          ...
          bio: "Medical doctor and biology professor. Specialized in human anatomy and physiology.",
          rating: 4.6,
          sessions: 134,
          profileImage: null,
        },
        {
          ...
          bio: "Native Spanish speaker and linguistics professor. Expert in language acquisition and teaching.",
          rating: 4.7,
          sessions: 167,
          profileImage: null,
        },
        {
          ...
          bio: "Statistics professor and data scientist. Expert in statistical analysis and data interpretation.",
          rating: 4.8,
          sessions: 145,
          profileImage: null,
        },
      ...
      this.allTutors = allTutors.map((tutor) => ({
        ...tutor,
      ...
      this.allTutors.sort((a, b) => (b.rating || 0) - (a.rating || 0));
    },
    requestTutor(tutor) {
